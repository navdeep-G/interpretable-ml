...
\title{Explaining the Predictions of Multinomial Classifiers\\\vspace{10pt}\small{A Discussion with Practical Recommendations and Applications to Financial Services}}
...
\author{Navdeep Gill\thanks{H2O.ai, Mountain View, CA}}
...
\begin{abstract}
  This paper discusses several explanatory methods that go beyond
  error measurements and plots traditionally  used to assess
  multinomial classifiers. Some of these methods are tools of the
  trade while others are rigorously derived and backed by long-
  standing theory. The methods, decision tree surrogate models,
  individual conditional expectation (ICE) plots, partial dependence
  plots, and Shapley explanations vary in terms scope and suitable
  application domain. Along with descriptions of these methods, this 
  paper presents real-world usage recommendataions in the financial services 
  domain space supported by a use case and in-depth software examples. 
\end{abstract}
